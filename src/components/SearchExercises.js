  ...
  return (
    <Stack alignItems="center" mt="37px" justifyContent="center" p="20px">
      ...
      <Box position="relative" mb="72px">
        ...
        <Button className="search-btn" sx={{backgroundColor: "#FF2625", color: '#FFF', textTransform: 'none', width: {lg: '175px', xs: '80px'}, fontSize: { lg: '20px', xs: '14px'}, height: '56px', position: 'absolute', right: '0'}} onClick={handleSearch}>Search</Button>
      </Box>
    </Stack>
  )
}
